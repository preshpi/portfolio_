  ...
  return (
    <div className="mt-[32px]">
      <div className="text-center">
        <span className="text-secondary dark:text-white text-[24px] lg:leading-[30px] font-[700]">
        ...
        <p className="text-[14px] leading-[24px] text-primary dark:text-white mt-[16px]">
